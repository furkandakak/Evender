...
import com.furkandakak.together.MainPageDetail
import com.furkandakak.together.databinding.RecyclerRowMainBinding
...
class MainPageRecyclerAdapter(private val postlist:ArrayList<Post>):RecyclerView.Adapter<MainPageRecyclerAdapter.PostHolder>()

{

    class PostHolder(val binding:RecyclerRowMainBinding):RecyclerView.ViewHolder(binding.root)
    {

    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostHolder {
        val binding =RecyclerRowMainBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    ...
    override fun onBindViewHolder(holder: PostHolder, position: Int) {
        ...
        {
            //page adress to go
            val intent=Intent(holder.itemView.context,MainPageDetail::class.java)
