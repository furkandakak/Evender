...
import com.furkandakak.together.pages.FavoriteEventDetail
import com.furkandakak.together.databinding.RecyclerRowFavoriteBinding
import com.furkandakak.together.model.Post
import java.util.*


class FavoriteEventRecyclerAdapter(private val postlist:ArrayList<Post>):RecyclerView.Adapter<FavoriteEventRecyclerAdapter.PostHolder>()

{

    class PostHolder(val binding: RecyclerRowFavoriteBinding):RecyclerView.ViewHolder(binding.root)
    {
    ...
    override fun onBindViewHolder(holder: PostHolder, position: Int) {
        ...
        {
            //page adress to go
            val intent=Intent(holder.itemView.context, FavoriteEventDetail::class.java)
